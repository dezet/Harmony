defmodule SymphonyElixir.RoadmapE2E do
    ...
    with {:ok, project} <- upsert_project(),
         ...
         {:ok, _blocker} <-
           Storage.upsert_open_blocker(%{
             ...
             target_id: Integer.to_string(run.forge_pr_number),
  ...
  defp seed_implementation_run(project, issue_id, identifier, opts \\ []) do
    ...
    Storage.upsert_work_run(%{
      ...
      forge_owner: project.forge_owner,
      forge_repo: project.forge_repo,
      forge_base_ref: project.forge_base_branch,
  ...
  defp to_runtime_work_run(stored_run, project, opts) do
    ...
    %WorkRun{
      ...
      forge_owner: stored_run.forge_owner,
      forge_repo: stored_run.forge_repo,
      forge_pr_number: stored_run.forge_pr_number,
      forge_head_sha: stored_run.forge_head_sha,
      forge_head_ref: stored_run.forge_head_ref,
      forge_base_ref: stored_run.forge_base_ref,
