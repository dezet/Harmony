defmodule SymphonyElixirWeb.Presenter do
  ...
  defp pr_link_payload(link) do
    %{
      id: link.id,
      github_owner: link.forge_owner,
      github_repo: link.forge_repo,
      github_pr_number: link.forge_pr_number,
      github_head_sha: link.forge_head_sha,
      github_head_ref: link.forge_head_ref,
      github_base_ref: link.forge_base_ref,
  ...
  defp work_run_list_item_payload(run) do
    %{
      ...
      github_owner: run.forge_owner,
      github_repo: run.forge_repo,
      github_pr_number: run.forge_pr_number,
      github_head_sha: run.forge_head_sha,
      github_head_ref: run.forge_head_ref,
      github_base_ref: run.forge_base_ref,
  ...
  defp durable_project_payload(project) do
    %{
      ...
      github: %{
        owner: project.forge_owner,
        repo: project.forge_repo,
