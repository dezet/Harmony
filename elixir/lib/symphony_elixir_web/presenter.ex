defmodule SymphonyElixirWeb.Presenter do
  ...
  defp pr_link_payload(link) do
    %{
      id: link.id,
      github_owner: link.forge_owner || link.github_owner,
      github_repo: link.forge_repo || link.github_repo,
      github_pr_number: link.forge_pr_number || link.github_pr_number,
      github_head_sha: link.forge_head_sha || link.github_head_sha,
      github_head_ref: link.forge_head_ref || link.github_head_ref,
      github_base_ref: link.forge_base_ref || link.github_base_ref,
  ...
  defp work_run_list_item_payload(run) do
    %{
      ...
      github_owner: run.forge_owner || run.github_owner,
      github_repo: run.forge_repo || run.github_repo,
      github_pr_number: run.forge_pr_number || run.github_pr_number,
      github_head_sha: run.forge_head_sha || run.github_head_sha,
      github_head_ref: run.forge_head_ref || run.github_head_ref,
      github_base_ref: run.forge_base_ref || run.github_base_ref,
